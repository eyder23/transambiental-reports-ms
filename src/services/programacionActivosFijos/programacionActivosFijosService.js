...
const ProgramacionActivosFijos = require('../../models/reports/ProgramacionActivosFijosModel');
...
exports.loadAsyncy = async (req, res) => {
  try {
    ...
    objectReportResume.code = 'PROGRAMACIONACTIVOSFIJOSTM';
    ...
    await workbook.xlsx.readFile(pathx).then(function() {
      ...
      workSheet.eachRow(function(row, rowNumber) {
        ...
        if (count === 0) {
          ...
          if (
            fileTitle !== constants.PROGRAMACION_ACTIVOS_FIJOS_TEMPLATE_TITLE
          ) {
        ...
        if (count > constants.PROGRAMACION_ACTIVOS_FIJOS_ROW_INIT) {
          const rowInsert = {
            claseActivoFijo: currRow.getCell(2).value,
            idActivoFijo: currRow.getCell(3).value,
            textoActivoFijo: currRow.getCell(4).value,
            periodoAnioContable: currRow.getCell(5).value,
            fechaCapitalizacion: customValidator.dateFromString(
              currRow.getCell(6).value
            ),
            monedaEmpresa: currRow.getCell(7).value,
            fecha: customValidator.dateFromString(currRow.getCell(8).value),
            fechaInicioDepreciacion: customValidator.dateFromString(
              currRow.getCell(9).value
            ),
            tasaAmortizacionEfectiva: currRow.getCell(10).value,
            ejercicioFiscal: currRow.getCell(11).value,
            ejercicioFiscalAdquisicion: currRow.getCell(12).value,
            estadoCicloVidaActivoFijo: currRow.getCell(13).value,
            fechaFinParalizacionTemporalActivoFijo: customValidator.dateFromString(
              currRow.getCell(14).value
            ),
            fechaInicioParalizacionTemporalActivoFijo: customValidator.dateFromString(
              currRow.getCell(15).value
            ),
            costeAdquisicionInicial: currRow.getCell(16).value,
            costeAdquisicionAlInicio: currRow.getCell(17).value,
            costeAdquisicionAlFinal: currRow.getCell(18).value,
            amortizacionAcumuladaAlInicio: currRow.getCell(19).value,
            depreciacionAcumuladaAlFinal: currRow.getCell(20).value,
            depreciacion: currRow.getCell(21).value,
            costesAdquisicion: currRow.getCell(22).value,
            valorNetoContableAlInicio: currRow.getCell(23).value,
            valorNetoContableAlFinal: currRow.getCell(24).value,
            capitalizacionRetroactiva: currRow.getCell(25).value,
            bajas: currRow.getCell(26).value,
            transferencias: currRow.getCell(27).value,
            ajusteValorCapitalizacionRetroactiva: currRow.getCell(28).value,
            ajusteValorParaBajas: currRow.getCell(29).value,
            ajusteValorParaTransferencias: currRow.getCell(30).value,
            amortizacion: currRow.getCell(31).value,
            revalorizaciones: currRow.getCell(32).value
          };
    ...
    await reportFunctionsUpdate.updateReportUploader(objectReportResume);
    const countDB = await ProgramacionActivosFijos.countDocuments();
    await ProgramacionActivosFijos.collection
...
exports.delete = async (req, res) => {
  try {
    await ProgramacionActivosFijos.deleteMany();
    // Defino objeto y variables estandar para el resumen de la carga
    const objectReportResume = {};
    objectReportResume.code = 'PROGRAMACIONACTIVOSFIJOSTM';
...
exports.getAll = async req => {
  ...
  features = new APIFeatures(
    ProgramacionActivosFijos.find()
      // .sort({ fechaInicioDepreciacion: 1 })
      .lean(),
    req.query
  )
    .sort()
  ...
  const featuresCounter = new APIFeatures(
    ProgramacionActivosFijos.countDocuments(),
    req.query
  );
  ...
  if (!isToDownload) {
    ...
    features = new APIFeatures(
      ...
      .filterTableAdvancedFilterDate(
        ...
        req.body.fechaInicioDepreciacionInit,
        req.body.fechaInicioDepreciacionEnd
      )
      .findByExact('claseActivoFijo', req.body.claseActivoFijo)
      .findByExact('idActivoFijo', req.body.idActivoFijo)
      .findByExact('textoActivoFijo', req.body.textoActivoFijo)
      .findByExact(
        'estadoCicloVidaActivoFijo',
        req.body.estadoCicloVidaActivoFijo
      )
      .limitFields()
  ...
  try {
    ...
    if (!reportInfo) {
      reportInfo = await reportDownloaderService.createReportByUser({
        name: 'Programación de Activos Fijos',
        code: objectReportResume.code,
        generatorUserId: objectReportResume.generatorUserId,
        reportType: objectReportResume.reportType
      });
    ...
    const nameFile = 'PROGRAMACION_DE_ACTIVOS_FIJOS';
    const pathTmp = path.resolve(__dirname, '../../resources/uploads/');
    ...
    const csvWriter = createCsvWriter({
      ...
      header: [
        ...
        {
          id: 'textoActivoFijo',
          title: 'Texto activo fijo'
        },
        {
          id: 'periodoAnioContable',
          title: 'Periodo año contable'
        },
        {
          id: 'fechaCapitalizacion',
          title: 'Fecha de Capitalización'
        },
        {
          id: 'monedaEmpresa',
          title: 'Moneda de empresa'
        },
        {
          id: 'fecha',
          title: 'Fecha'
        },
        {
          ...
          title: 'Fecha de inicio de depreciación'
        },
        {
          id: 'tasaAmortizacionEfectiva',
          title: 'Tasa de amortización efectiva'
        },
        {
          id: 'ejercicioFiscal',
          title: 'Ejercios fiscal'
        },
        {
          id: 'ejercicioFiscalAdquisicion',
          title: 'Ejercicio fiscal adquisición'
        },
        {
          id: 'estadoCicloVidaActivoFijo',
          title: 'Estado de ciclo de vida activo fijo'
        },
        {
          id: 'fechaFinParalizacionTemporalActivoFijo',
          title: 'Fecha de Fin de Paralización Temporal de Activo Fijo'
        },
        {
          id: 'fechaInicioParalizacionTemporalActivoFijo',
          title: 'Fecha de inicio de Paralización Temporal de Activo Fijo'
        },
        {
          id: 'costeAdquisicionInicial',
          title: 'Coste de adquisición inicial'
        },
        {
          id: 'costeAdquisicionAlInicio',
          title: 'Coste de adquisición al inicio'
        },
        {
          id: 'costeAdquisicionAlFinal',
          title: 'Coste de adquisición al final'
        },
        {
          id: 'amortizacionAcumuladaAlInicio',
          title: 'Amortización acumulada al inicio'
        },
        {
          id: 'depreciacionAcumuladaAlFinal',
          title: 'Depreciación acumulada al final'
        },
        {
          id: 'depreciacion',
          title: 'Depreciación'
        },
        {
          ...
          title: 'Costes de adquisición'
        },
        {
          id: 'valorNetoContableAlInicio',
          title: 'Valor neto contable al inicio'
        },
        {
          id: 'valorNetoContableAlFinal',
          title: 'Valor neto contable al final'
        },
        {
          id: 'capitalizacionRetroactiva',
          title: 'Capitalización retroactiva'
        },
        {
          id: 'bajas',
          title: 'Bajas'
        ...
        {
          id: 'ajusteValorCapitalizacionRetroactiva',
          title: 'Ajuste valor capitalización retroactiva'
        },
        {
          id: 'ajusteValorParaBajas',
          title: 'Ajuste valor para bajas'
        },
        {
          id: 'ajusteValorParaTransferencias',
          title: 'Ajuste valor para transferencias'
        },
        {
          id: 'amortizacion',
          title: 'Amorización'
    ...
    reportData.forEach(function(cursor, index, object) {
      cursor.fechaCapitalizacion = customValidator.stringFromDate(
        cursor.fechaCapitalizacion
      );
      cursor.fecha = customValidator.stringFromDate(cursor.fecha);
      cursor.fechaInicioDepreciacion = customValidator.stringFromDate(
        cursor.fechaInicioDepreciacion
      );
      cursor.fechaFinParalizacionTemporalActivoFijo = customValidator.stringFromDate(
        cursor.fechaFinParalizacionTemporalActivoFijo
      );
      cursor.fechaInicioParalizacionTemporalActivoFijo = customValidator.stringFromDate(
        cursor.fechaInicioParalizacionTemporalActivoFijo
      );
      cursor.costeAdquisicionInicial = customValidator.numberToStringDecimal(
        cursor.costeAdquisicionInicial
      );
      cursor.costeAdquisicionAlInicio = customValidator.numberToStringDecimal(
        cursor.costeAdquisicionAlInicio
      );
      cursor.costeAdquisicionAlFinal = customValidator.numberToStringDecimal(
        cursor.costeAdquisicionAlFinal
      );
      cursor.amortizacionAcumuladaAlInicio = customValidator.numberToStringDecimal(
        cursor.amortizacionAcumuladaAlInicio
      );
      cursor.depreciacionAcumuladaAlFinal = customValidator.numberToStringDecimal(
        cursor.depreciacionAcumuladaAlFinal
      );
      cursor.depreciacion = customValidator.numberToStringDecimal(
        cursor.depreciacion
      );
      cursor.costesAdquisicion = customValidator.numberToStringDecimal(
        cursor.costesAdquisicion
      );
      cursor.valorNetoContableAlInicio = customValidator.numberToStringDecimal(
        cursor.valorNetoContableAlInicio
      );
      cursor.valorNetoContableAlFinal = customValidator.numberToStringDecimal(
        cursor.valorNetoContableAlFinal
      );
      cursor.capitalizacionRetroactiva = customValidator.numberToStringDecimal(
        cursor.capitalizacionRetroactiva
      );
      ...
      cursor.ajusteValorCapitalizacionRetroactiva = customValidator.numberToStringDecimal(
        cursor.ajusteValorCapitalizacionRetroactiva
      );
      cursor.ajusteValorParaBajas = customValidator.numberToStringDecimal(
        cursor.ajusteValorParaBajas
      );
      cursor.ajusteValorParaTransferencias = customValidator.numberToStringDecimal(
        cursor.ajusteValorParaTransferencias
      );
      cursor.amortizacion = customValidator.numberToStringDecimal(
        cursor.amortizacion
      );
      cursor.revalorizaciones = customValidator.numberToStringDecimal(
        cursor.revalorizaciones
      );
    });
